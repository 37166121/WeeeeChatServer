...
public class RSAUtil {
    ...
    public static String getPublicToBase64String() {
        return new String(Base64.getEncoder().encode(RSAUtil.key.getPublic().getEncoded()));
    }

    public static String getPrivateToBase64String() {
        return new String(Base64.getEncoder().encode(RSAUtil.key.getPrivate().getEncoded()));
    }

    public static byte[] getPublic() {
        return RSAUtil.key.getPublic().getEncoded();
    }

    public static byte[] getPrivate() {
        return RSAUtil.key.getPrivate().getEncoded();
    }
